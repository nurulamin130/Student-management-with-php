            ...
            <div class="panel panel-primary">
              <div class="panel-heading">
                <div class="row">
                  <div class="col-xs-3"><i class="fa fa-users fa-5x"></i></div>
                  <div class="col-xs-9">
                    <div class="pull-right" style="font-size:45px"> Homepage </div>
                    <div class="clearfix"></div>
                    <div class="pull-right">A detailed Homepage</div>
                 ...
                 <a href="index.php?page=index">
                    <div class="panel-footer">
                      <span class="pull-left "> Click link to go to Homepage</span>
                      <span class="pull-right "><i class="fa fa-arrow-circle-o-right"></i></span>
                     <div class="clearfix"></div>
                    </div>
                 </a>
